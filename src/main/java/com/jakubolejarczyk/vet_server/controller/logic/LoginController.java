...
public class LoginController extends StepRunnerController<LoginData, LoginMetadata> {
    private final GetTokenByLoginDetailsStep<LoginData, LoginMetadata>  getTokenByLoginDetailsStep;
    ...
    public LoginController(
        ...
        GetTokenByLoginDetailsStep<LoginData, LoginMetadata> getTokenByLoginDetailsStep,
