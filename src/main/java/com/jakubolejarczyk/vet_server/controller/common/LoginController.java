...
import com.jakubolejarczyk.vet_server.dto.metadata.LoginMetadata;
...
public class LoginController extends BaseController<LoginRequest, LoginData, LoginMetadata> {
    ...
    public LoginController(
            ...
            ObjectFactory<ResponseService<LoginData, LoginMetadata>> responseService,
    ...
    @Override
    @PostMapping("login")
    public ResponseEntity<Response<LoginData, LoginMetadata>>
