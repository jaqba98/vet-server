...
public class ServiceController {
    ...
    public ResponseEntity<ResponseDto> service(@Valid @RequestBody ClinicRequestDto requestDto) {
//        // Clean response
...
//        // Response
        ...
        return responseStep.getObject().getStep(true, Clinic.builder().build());
    }
