...
//        // MetaData client id
//        val petsClientIdMetaData = new BaseMetadata();
//        clientsData.forEach(client -> {
//            petsClientIdMetaData.addValue(client.getId(), client.getFullName());
//        });
//        stepStore.setItem("petsClientIdMetaData", petsClientIdMetaData);
//    }
//}
