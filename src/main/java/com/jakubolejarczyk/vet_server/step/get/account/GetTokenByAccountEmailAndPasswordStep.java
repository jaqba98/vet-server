...
@Service
@AllArgsConstructor
public class GetTokenByAccountEmailAndPasswordStep<TData, TMetadata> implements StepRunnerModel<TData, TMetadata> {
    ...
    public void runStep(StepStore<TData, TMetadata> stepStore) {
        ...
        stepStore.addMessage("Incorrect email or password");
    }
}
